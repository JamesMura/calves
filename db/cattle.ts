...
export class Cattle extends IBaseModule<TableNames>{
    ...
    constructor(tag: string, sex: string, dateOfBirth: string, description: string, parentSire: string, parentDame: string, purchaseDate: string, purchasedFrom: string) {
        super("Cattle");
        this.tag = tag;
        this.sex = sex;
    ...
    static GetTableStructor() {
        return new TableStructor<Cattle, TableNames>(
            "Cattle",
            [
